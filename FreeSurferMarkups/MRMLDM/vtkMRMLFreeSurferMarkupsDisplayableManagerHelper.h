...
==============================================================================*/
/// .NAME vtkMRMLFreeSurferMarkupsDisplayableManagerHelper - utility class to manage widgets
/// .SECTION Description
...
#ifndef VTKMRMLFREESURFERMARKUPSDISPLAYABLEMANAGERHELPER_H_
#define VTKMRMLFREESURFERMARKUPSDISPLAYABLEMANAGERHELPER_H_
...
class VTK_SLICER_FREESURFERMARKUPS_MODULE_MRMLDISPLAYABLEMANAGER_EXPORT vtkMRMLFreeSurferMarkupsDisplayableManagerHelper :
    public vtkObject
{
public:

  static vtkMRMLFreeSurferMarkupsDisplayableManagerHelper *New();
  vtkTypeMacro(vtkMRMLFreeSurferMarkupsDisplayableManagerHelper, vtkObject);
...
protected:
  ...
  vtkMRMLFreeSurferMarkupsDisplayableManagerHelper();
  ~vtkMRMLFreeSurferMarkupsDisplayableManagerHelper() override;

private:

  vtkMRMLFreeSurferMarkupsDisplayableManagerHelper(const vtkMRMLFreeSurferMarkupsDisplayableManagerHelper&) = delete;
  void operator=(const vtkMRMLFreeSurferMarkupsDisplayableManagerHelper&) = delete;
...
#endif /* VTKMRMLFREESURFERMARKUPSDISPLAYABLEMANAGERHELPER_H_ */

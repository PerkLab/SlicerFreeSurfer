...
#include "vtkMRMLFreeSurferMarkupsDisplayableManagerHelper.h"
...
//---------------------------------------------------------------------------
vtkStandardNewMacro (vtkMRMLFreeSurferMarkupsDisplayableManagerHelper);

//---------------------------------------------------------------------------
vtkMRMLFreeSurferMarkupsDisplayableManagerHelper::vtkMRMLFreeSurferMarkupsDisplayableManagerHelper()
{
...
//---------------------------------------------------------------------------
void vtkMRMLFreeSurferMarkupsDisplayableManagerHelper::PrintSelf(ostream& os, vtkIndent indent)
{
...
//---------------------------------------------------------------------------
vtkSlicerMarkupsWidget* vtkMRMLFreeSurferMarkupsDisplayableManagerHelper::GetWidget(vtkMRMLMarkupsNode * markupsNode)
{
  if (!markupsNode)
    {
    return nullptr;
    }
  vtkMRMLFreeSurferMarkupsDisplayableManagerHelper::MarkupsNodesIt displayableIt =
  ...
  for (vtkMRMLFreeSurferMarkupsDisplayableManagerHelper::DisplayNodeToWidgetIt widgetIterator = this->MarkupsDisplayNodesToWidgets.begin();
    widgetIterator != this->MarkupsDisplayNodesToWidgets.end();
    ++widgetIterator)
    {
...
//---------------------------------------------------------------------------
vtkSlicerMarkupsWidget * vtkMRMLFreeSurferMarkupsDisplayableManagerHelper::GetWidget(vtkMRMLMarkupsDisplayNode * node)
{
  if (!node)
    {
    return nullptr;
...
//---------------------------------------------------------------------------
void vtkMRMLFreeSurferMarkupsDisplayableManagerHelper::RemoveAllWidgetsAndNodes()
{
  DisplayNodeToWidgetIt widgetIterator = this->MarkupsDisplayNodesToWidgets.begin();
  for (widgetIterator =  this->MarkupsDisplayNodesToWidgets.begin();
       widgetIterator != this->MarkupsDisplayNodesToWidgets.end();
...
//---------------------------------------------------------------------------
void vtkMRMLFreeSurferMarkupsDisplayableManagerHelper::AddMarkupsNode(vtkMRMLMarkupsNode* node)
{
  if (!node)
    {
    return;
...
//---------------------------------------------------------------------------
void vtkMRMLFreeSurferMarkupsDisplayableManagerHelper::RemoveMarkupsNode(vtkMRMLMarkupsNode* node)
{
  if (!node)
    {
    return;
  ...
  for (vtkMRMLFreeSurferMarkupsDisplayableManagerHelper::DisplayNodeToWidgetIt widgetIterator = this->MarkupsDisplayNodesToWidgets.begin();
    ...
    if (markupsDisplayNode->GetDisplayableNode() != node)
      ...
      vtkMRMLFreeSurferMarkupsDisplayableManagerHelper::DisplayNodeToWidgetIt widgetIteratorToRemove = widgetIterator;
      ++widgetIterator;
...
//---------------------------------------------------------------------------
void vtkMRMLFreeSurferMarkupsDisplayableManagerHelper::AddDisplayNode(vtkMRMLMarkupsDisplayNode* markupsDisplayNode)
{
  ...
  vtkMRMLFreeSurferMarkupsDisplayableManagerHelper::DisplayNodeToWidgetIt displayNodeIt
...
//---------------------------------------------------------------------------
void vtkMRMLFreeSurferMarkupsDisplayableManagerHelper::RemoveDisplayNode(vtkMRMLMarkupsDisplayNode* markupsDisplayNode)
{
  if (!markupsDisplayNode)
    {
    return;
...
//---------------------------------------------------------------------------
void vtkMRMLFreeSurferMarkupsDisplayableManagerHelper::DeleteWidget(vtkSlicerMarkupsWidget* widget)
{
  if (!widget)
    {
    return;
...
//---------------------------------------------------------------------------
void vtkMRMLFreeSurferMarkupsDisplayableManagerHelper::AddObservations(vtkMRMLMarkupsNode* node)
{
...
//---------------------------------------------------------------------------
void vtkMRMLFreeSurferMarkupsDisplayableManagerHelper::RemoveObservations(vtkMRMLMarkupsNode* node)
{
  vtkCallbackCommand* callbackCommand = this->DisplayableManager->GetMRMLNodesCallbackCommand();
  vtkEventBroker* broker = vtkEventBroker::GetInstance();
  for (auto observedMarkupNodeEvent : this->ObservedMarkupNodeEvents)
...
//---------------------------------------------------------------------------
void vtkMRMLFreeSurferMarkupsDisplayableManagerHelper::SetDisplayableManager(vtkMRMLMarkupsDisplayableManager* displayableManager)
{
